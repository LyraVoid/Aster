// Adapted from FolkPatch-miuix; see the repository GPL-3.0 license.
...
import me.bmax.apatch.ui.animation.DampedDragAnimation
import me.bmax.apatch.ui.animation.InteractiveHighlight
...
fun FloatingBottomBar(
    ...
    val currentCanSelect by androidx.compose.runtime.rememberUpdatedState(canSelect)
    val currentSelectedIndex by androidx.compose.runtime.rememberUpdatedState(selectedIndex)
    val currentOnSelected by androidx.compose.runtime.rememberUpdatedState(onSelected)
    val isInLightTheme = !me.bmax.apatch.ui.theme.LocalThemeModeState.current.isDark
